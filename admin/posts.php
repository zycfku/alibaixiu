    ...
    <div class="container-fluid">
      ...
      <div class="page-action">
        ...
        <ul class="pagination pagination-sm pull-right">
          <!-- <li><a href="#" class="preview">上一页</a></li>
          <li><a href="#">1</a></li>
          <li><a href="#">2</a></li>
          <li><a href="#">3</a></li>
...
<?php $posts = 'posts'; ?>
  ...
  <script type="text/template" id="postsData">
  {{each list as v k}} 
  <tr>
            <td class="text-center"><input type="checkbox"></td>
            <td>{{v.title}}</td>
...
<script type="text/template" id="pageData">
 <li><a href="javascrit:;" class="preview pageNum=1? disabled : ''">上一页</a></li>
     ...
     function render(pageNum,pageSize) {
      $.ajax({
       ...
       success: function(res) {
         if(res.code == 1) {
          var str = template('postsData',{list: res.data});
          $('tbody').html(str);
         }
       }
     });
